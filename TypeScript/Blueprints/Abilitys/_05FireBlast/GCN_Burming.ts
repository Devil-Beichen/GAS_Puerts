...
// 资产路径
const AssetPath = "/Game/Blueprints/Abilitys/_05FireBlast/GCN_Burming.GCN_Burming_C";

// 创建一个继承ts类（或者其他类）的接口（用来类型提示）
export interface GCN_Burming extends UE.Game.Blueprints.Abilitys._05FireBlast.GCN_Burming.GCN_Burming_C {
}
...
export class GCN_Burming implements GCN_Burming {
    ...
    FireEmittCom: UE.ParticleSystemComponent = new UE.ParticleSystemComponent();
